...
case 'pushjeda' : {
          if (!text) return m.reply(`Example ${prefix}${command} Sv YogzzDevX`)
          if (!isCreator) return m.reply(mess.OnlyOwner)
...
//=================================================//
case 'ping': {
kurrxd.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/ae43178627ea50dd44895.jpg' }, caption: `command : ${prefix}
...
case 'panelmenu':
        m.reply(`proses`)
        kurrxd.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/ae43178627ea50dd44895.jpg' }, caption:`
– *Panel Menu*
...
┗━━━━━━━━━━━━━━━━━━━`);
        ...
        break
case 'domain10': {
    if (!jangan) return m.reply("maaf grup ini blom di add oleh YogzzDevX")
           function subDomain1(host, ip) {
             return new Promise((resolve) => {
...
if (!isCreator) return m.reply('Lu Bukan YogzzDevX Asu')
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
...
break
        ...
        case "1gb": {
if (!isSeler) return m.reply(`Emang lu udah join reseller di YogzzDevX? kalau belum gausah pake fitur ini blok`)
let t = text.split(',');
if (t.length < 2) return m.reply(`*Format salah!*
Penggunaan:
${prefix + command} user,nomer`)
...
akunlo = "https://telegra.ph/file/ae43178627ea50dd44895.jpg" 
if (!u) return
let d = (await kurrxd.onWhatsApp(u.split`@`[0]))[0] || {}
